local defaults = {
  ...
  shards: 5,
  remoteWrite: [
    { url: 'http://172.31.5.206:8428/api/v1/write' }
  ],
  retention: '10m',
  scrapeInterval: '15s',
  scrapeTimeout: '15s',
...
function(params) {
  ...
  prometheus: {
    ...
    spec: {
      ...
      shards: p._config.shards,
      evaluationInterval: p._config.evaluationInterval,
      scrapeInterval: p._config.scrapeInterval,
      scrapeTimeout: p._config.scrapeTimeout,
      remoteWrite: p._config.remoteWrite,
